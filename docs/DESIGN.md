...
> Design notes for **gdpr-ecommerce-account-deletion** — a runnable python example that Python account deletion workflow that revokes sessions and clears order records.
...
- **Feature code** — the actual task: gdpr-account-delete.
